process DCC {
    ...
    if (meta.single_end) {
        ...
        circtools detect @samplesheet -D -an ${gtf} ${args} -F -M -Nr 1 1 -A ${fasta} ${strand_args} -T ${task.cpus}
        ...
        circtools detect @samplesheet -mt1 @mate1file -mt2 @mate2file -D -an ${gtf} ${args} -Pi -F -M -Nr 1 1 -A ${fasta} ${strand_args} -T ${task.cpus}
