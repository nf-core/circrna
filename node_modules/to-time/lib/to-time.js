(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.toTime = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var transforms = [['Years', constants.SECONDS_IN_YEAR], ['Weeks', constants.SECONDS_IN_WEEK], ['Days', constants.SECONDS_IN_DAY], ['Hours', constants.SECONDS_IN_HOUR], ['Minutes', constants.SECONDS_IN_MINUTE], ['Seconds', constants.ONE_SECOND], ['Milliseconds', constants.SECONDS_IN_MILLISECOND]];
    ...
    _createClass(TimeFrame, [{
        ...
        value: function humanize() {
            ...
            transforms.forEach(function (t) {
                var div = val.dividedToIntegerBy(t[1]);
                if (div.toNumber() > 0) {
                    //If div value is 1, slice the "s" from the unit name
                    var unit = div > 1 ? t[0] : t[0].slice(0, -1);
...
},{"./constants":4,"bignumber.js":1}],3:[function(require,module,exports){
'use strict';
...
var toTime = function toTime(text) {
    /**
    ...
    var seconds = splitted.filter(function (v) {
        return v.match(matchPattern);
    }).map(function (v) {
        var numeric = v.match(/\d+(.[\d]+)?(\s+)?/)[0];
...
toTime.fromWeeks = function (weeks) {
...
},{"./TimeFrame":2,"./constants":4,"bignumber.js":1}],4:[function(require,module,exports){
"use strict";
